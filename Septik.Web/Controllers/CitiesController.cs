...
namespace Septik.Web.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            var cities = _context.Cities.Select(x=>new CityItemVM() {Id=x.Id, Name = x.Name, Images = _context.CityImages.Where(t=>t.CityId == x.Id).ToList() }); 
        ...
        {
            var entity = _context.Cities.Include(t => t.CityImages).FirstOrDefault(c => c.Id == id);
            if(entity != null)
            {
                return View(entity);
            }
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                var t = _context.Cities.FirstOrDefault(t => t.Id == id);
